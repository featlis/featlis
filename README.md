...
Twitter(X)のURLをスラッシュコマンドで渡すと、ツイートの綺麗なスクリーンショット画像をDiscord上に返すBot。
...
#### ✨ 主な機能と技術的な工夫
* **高品質な画像生成**: `tweetcapture` を用いて、RT・いいね数なども含めたツイートの完全なスクリーンショットを生成。
* **柔軟なテーマ対応**: スラッシュコマンド引数でライト・ダーク・ブラックモードを切り替え可能。
